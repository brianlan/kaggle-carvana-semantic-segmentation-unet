...
log_path = "/home/rlan/projects/Kaggle/Carnava/kaggle-carvana-semantic-segmentation-unet/log/20170915"
output_path = "/tmp/train_val_error.csv"

train_output = subprocess.check_output("cat {} | grep 'batch 254] training loss' | awk '{{print $14}}'".format(log_path), shell=True)
