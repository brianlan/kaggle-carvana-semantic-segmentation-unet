...
def random_hsv_shift(image, mask, hue_shift_limit=(-180, 180), sat_shift_limit=(-255, 255), val_shift_limit=(-255, 255),
                     u=0.5):
    if np.random.random() < u:
...
def random_shift_scale_rotate(image, mask, shift_limit=(-0.0625, 0.0625), scale_limit=(-0.1, 0.1),
